<div class="px-4 py-12 mx-auto max-w-7xl">
    <h2 class="text-xl font-semibold text-gray-900 mb-4">Descripción general</h2>
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
        <div class="flex-row items-center p-5 card bg-pink-100">
            ...
            <div class="ml-3">
                <h2 class="mb-1 text-lg font-bold leading-none text-gray-900 truncate">{{$users}}</h2>
                <p class="text-sm leading-none text-gray-600">Usuarios</p>
            </div>
        </div>
        <div class="flex-row items-center p-5 card bg-green-100">
        ...
        <div class="flex-row items-center p-5 card bg-red-100">
        ...
        <div class="flex-row items-center p-5 card bg-yellow-100">
